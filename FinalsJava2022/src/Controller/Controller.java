...
import View.JAdminUpd;
import View.JAdminRem;
import View.JRegister;
import View.JAdminAdd;
import Model.Model;
                ...
                if (rs.next()) {
                    ...
                    try {
                        ...
                        if (age >= 18 && age <= 130) {
                            ...
                            JOptionPane.showMessageDialog(r, "Minor or Age more than 130 is not ALLOWED", "Error", JOptionPane.ERROR_MESSAGE);
                        }
